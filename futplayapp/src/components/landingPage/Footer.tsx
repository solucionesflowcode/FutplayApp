export default function Footer() {
    return (
        <footer className="fixed bottom-0 left-0 right-0 z-50 bg-[#001730]/90 backdrop-blur-md text-gray-400 py-4 border-t border-white/5">
            <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-3 gap-4">
                <div>
                    <h3 className="text-xl font-black text-white mb-2">Futplay<span className="text-[#f59e0b]">.</span></h3>
                ...
                <div>
                    <h4 className="text-white font-bold mb-2 text-sm">Sedes Físicas</h4>
                ...
                <div>
                    <h4 className="text-white font-bold mb-2 text-sm">Contáctanos</h4>
