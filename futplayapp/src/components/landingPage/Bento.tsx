  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-8">
        <div className="bg-gray-50 p-12 border-t-2 border-t-[#002a58] border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
        ...
        <div className="bg-gradient-to-br from-[#f59e0b] to-[#c26d03] p-12 border-t-2 border-t-white/30 text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-shadow">
