...
export default function PlanesRender() {
    ...
    return (
        <div className="w-full bg-gradient-to-br from-[#001c37] to-[#00305B] px-8 py-8 shadow-xl mt-6 text-white relative overflow-hidden border-t-2 border-t-[#F39200]">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
                <div className="flex-1 space-y-4">
                    ...
                    <Link href="/planes">
                        <button className="mt-4 bg-[#F28C28] hover:bg-[#e07d1f] text-white px-8 py-3 rounded font-bold transition-all shadow-[0_0_15px_rgba(242,140,40,0.4)] hover:shadow-[0_0_25px_rgba(242,140,40,0.6)] transform hover:-translate-y-1">
                ...
                <div className="flex-1 w-full flex flex-col sm:flex-row gap-4 justify-center lg:justify-end">
                    {planes.map((plan) => (
                        <div key={plan.id} className="bg-white/10 backdrop-blur-md border border-white/20 p-6 flex flex-col w-full sm:w-[250px] shadow-lg hover:bg-white/15 transition-all border-t-2 border-t-[#F28C28]">
                    ...
                    {planes.length === 0 && (
                        <div className="bg-white/5 border border-white/10 p-6 flex flex-col justify-center items-center text-center w-full sm:w-[280px]">
